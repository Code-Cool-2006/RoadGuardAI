      ...
      <header className={`sticky top-0 z-50 border-b backdrop-blur-md shadow-sm ${isDark ? 'border-slate-800/80 bg-slate-950/90' : 'border-[#2B2653]/10 bg-white/90'}`}>
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <nav className="flex items-center gap-1 sm:gap-2">
            ...
            <button onClick={handleLogout} className={`flex items-center gap-2 rounded-full border px-3 py-2 text-sm transition ${isDark ? 'border-slate-800 bg-slate-900/70 text-slate-200 hover:bg-slate-800' : 'border-[#2B2653]/15 bg-white text-[#2B2653] hover:bg-[#F8F6F0]'}`}>

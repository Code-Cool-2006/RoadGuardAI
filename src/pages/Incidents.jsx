    ...
    <div className="rounded-[24px] border border-slate-800 bg-slate-900/70 p-6 text-slate-300">
      <div className="flex items-center justify-between">
        <div>
          ...
          <h1 className="mt-2 text-2xl font-semibold text-white">Incident feed</h1>
        </div>
      ...
      <div className="mt-8 grid gap-4 lg:grid-cols-2">
        {['Harbor Avenue resurfacing', 'School gate water repair', 'Downded power line inspection'].map((item) => (

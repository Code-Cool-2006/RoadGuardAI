...
const AnimatedCtaButton = () => {
  return (
    <Link
      to="/login"
      className="group relative inline-flex items-center gap-3 rounded-full bg-[#2B2653] px-6 py-3.5 text-sm font-bold text-white shadow-lg transition-all duration-300 hover:bg-[#1E1B4B] hover:shadow-xl hover:scale-105"
    >
